...
namespace ota
{
    int getVersionStatus()
    {
        ...
        */
        ...
        {
            WiFiClient secureWifiClient;
            HTTPClient http;

            const std::string endpoint = "http://10.108.10.48:3333/version";
    ...
    int downloadAndInstallNewVersion()
    {
        ...
        */
        ...
        std::string endpoint = "http://10.108.10.48:3333/update?version=" + newestVersionFromServer;
        ...
        case HTTP_UPDATE_NO_UPDATES:
            Serial.println("Não deu certo atualizar por um motivo desconhecido");
            return 0;

        case HTTP_UPDATE_OK:
            Serial.println("Bora atualizar");
